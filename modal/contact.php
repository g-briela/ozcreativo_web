...
$php_main_email = "ozcreativo@316studio.com.mx";
...
if (filter_var($php_email, FILTER_VALIDATE_EMAIL)) {
		...
		$php_subject = "Mensaje desde su formulario de contacto de Oz Valadez";
		...
		. 'Gracias por ponerse en contacto.<br/><br/>'
		...
		. '<br/>'
		. 'Nos pondremos en contacto lo antes posible .</div>';
